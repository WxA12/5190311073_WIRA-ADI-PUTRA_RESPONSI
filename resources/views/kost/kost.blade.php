...
<table class="table table-success table-striped-columns">
  ...
  <tbody>
    <tr>
      ...
      <td>{{ $i -> idkost }}</td>
      <td>{{$i ->name_kost}}</td>
      <td>{{$i ->nokamar_kost}}</td>
      <td>{{$i ->alamat}}</td>
      <td>{{$i ->id_ibukost}}</td>
      <td>{{$i ->id_anakkost}}</td>
      <td>
        <a href='/kost/edit/{{$i -> idkost}}'><button type="button" class="btn btn-warning">Update</button></a>
        <a href='/kost/delete/{{$i -> idkost}}'><button type="button" class="btn btn-danger">Delete</button></a>
    </tr>
   @endforeach
  </tbody>
</table>
